...
export declare const getNextResizeGroupStateProvider: (measurementCache?: {
    getCachedMeasurement: (data: any) => number | undefined;
    addMeasurementToCache: (data: any, measurement: number) => void;
}) => (props: IResizeGroupProps, currentState: IResizeGroupState, getElementToMeasureWidth: () => number, newContainerWidth?: number | undefined) => IResizeGroupState | undefined;
export declare class ResizeGroup extends BaseComponent<IResizeGroupProps, IResizeGroupState> {
    private _getNextResizeGroupState;
    private _root;
    private _measured;
