define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/Layer", "@uifabric/example-app-base", "./examples/HoverCard.Basic.Example", "./HoverCardPage.scss"], function (require, exports, tslib_1, React, Link_1, Layer_1, example_app_base_1, HoverCard_Basic_Example_1) {
    "use strict";
        ...
        HoverCardPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'HoverCard', componentName: 'HoverCardExample', exampleCards: React.createElement(Layer_1.LayerHost, null,
                    React.createElement(example_app_base_1.ExampleCard, { title: 'HoverCard', code: HoverCardBasicExampleCode },
                        React.createElement(HoverCard_Basic_Example_1.HoverCardBasicExample, null))), propertiesTables: React.createElement(example_app_base_1.PropertiesTableSet, { sources: [
