...
var DialogBasicExample = (function (_super) {
    ...
    DialogBasicExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement("label", { id: 'myLabel', className: 'screenReaderOnly' }, "All emails together Your Inbox has changed. No longer does it include favorites, it is a singular destination for your emails."),
